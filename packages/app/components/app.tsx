...
import { OrlojMark, Divider, Pill } from "./ornaments";
import { TopNav, LoginModal } from "./auth";
import { Landing } from "./landing";
import { Explore } from "./explore";
import { Register } from "./register";
import { Profile } from "./profile";
import type { Mcp } from "./data";
...
const ROUTES = ["home", "explore", "register", "profile", "docs"] as const;
...
export const App = () => {
  ...
  const [bindMcp, setBindMcp] = useState<Mcp | null>(null);
  ...
  const navigate = (r: string) => {
    ...
    setRoute(ROUTES.includes(r as Route) ? (r as Route) : "home");
  ...
  return (
    <>
      ...
      {route === "explore" && (
        <Explore onNavigate={navigate} onBind={handleBind} />
      )}
...
const Footer = ({ onNavigate }: { onNavigate: (r: string) => void }) => (
  <footer
    style={{
      marginTop: 60,
      padding: "40px 32px",
